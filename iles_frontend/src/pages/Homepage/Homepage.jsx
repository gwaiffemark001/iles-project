            ...
            <div className="homepage-copy">
              ...
              <section className="homepage-team-section">
                <div className="main-card">
                  <div className="inner-card system-card">
                    <div className="system-card-left">
                      <img className="system-card-logo" src="/ILES-Logo.png" alt="ILES logo" />
                    </div>
                    <div className="system-card-right">
                      <h2>Internship Logging & Evaluation</h2>
                      <p>Streamline internship supervision, logging, and evaluations for students, supervisors, and administrators.</p>
                  ...
                  <div className="inner-card collaborators-card">
